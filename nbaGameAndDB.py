...
print("test what is in player list:")
print(player_list[0])
...
def provide_feedback(answer_dict, guess):
    ...
    if answer_dict['CompareHeight'] == compare:
        ...
        feedback_parts.append(("closel", str(height) + " ↓"))
        print((answer_dict['CompareHeight']) - compare)
    else:
    ...
    if answer_dict['Jersey Number'] == num:
        ...
        print((answer_dict['Jersey Number'] - num))
        feedback_parts.append(("closel", str(num) + " ↓"))
        print(num)
    else:
...
def play():
    ...
    if request.method == 'POST':
        ...
        if guess.lower() == secret_word.lower():
            ...
            guess_history.append({"guess": guess, "feedback": feedback_parts})
            correct = False
